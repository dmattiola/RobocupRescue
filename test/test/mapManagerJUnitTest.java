...
public class mapManagerJUnitTest {
    ...
    public void setUp() {
        ...
        n1 = new Node(100, 100,1, "BASE");
        n2 = new Node(110, 110,2, "BASE");
        n3 = new Node(90, 90,3, "BASE");
        n4 = new Node(120, 120,4, "BASE");
        n5 = new Node(80, 80,5, "INCENDIE");
        n6 = new Node(90, 110,6, "INCENDIE");
        ...
        mm.setGr(g);
        RobotCaterpillar r1 = new RobotCaterpillar();
        r1.setNode(n1);
        r1.setName("r1");
        mm.getListRobot().add(r1);
        RobotLegs r2 = new RobotLegs();
        r2.setNode(n2);
        r2.setName("r2");
        mm.getListRobot().add(r2);
        RobotCrossCountry r3 = new RobotCrossCountry();
        r3.setNode(n3);
        r3.setName("r3");
