        ...
        try{
            ...
            do {
                ...
                if (line.indexOf("<node") != -1){
                    ...
                    Node node = new Node(Integer.parseInt(node_xml[1]),(int)Double.parseDouble(node_xml[3]),(int)Double.parseDouble(node_xml[5]),node_xml[7]);
                    max = Math.max(max, node.getId());
                    if (node.getType().equals("INCENDIE")){
                        node.kindleFire();
                    }
                ...
                if (line.indexOf("<edge") != -1){
                    ...
                    Edge edge = new Edge(findNode(g,Integer.parseInt(edge_xml[1])),findNode(g,Integer.parseInt(edge_xml[3])),edge_xml[5]);
