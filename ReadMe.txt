...
Pour créer ce graphe, il faut ajouter des noeuds et les lier par des arcs. 
Vous pouvez choisir le type des arcs à l'aide de la liste.

Ensuite, il faut ajouter des feux, ces feux peuvent être ajouter sur des noeuds. 
Il en est de même pour les stations de rechargement.
...
Ensuite, il faut ajouter des robots qui iront éteindre les feux. 
Vous avez le choix entre plusieurs types de robots.
...
Lancer la simulation avec le bouton "Lancer". 
Pour l'arrêter, cliquer sur le bouton "Arrêter".
